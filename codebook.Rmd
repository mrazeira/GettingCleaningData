...
Brief description of the data obtained in the attached document.
...
The data has been downloaded from the link below
...
## Processing the data
 ...
 The flow of the process are given by:
...
More details about the data processing, check the run_analisys.R file.
...
## Show a few rows of the tidy dataset
